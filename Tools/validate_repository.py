...
REQUIRED_FILES = [
    ...
    "Assets/Project77/Puzzle/PrototypeAttemptPolicy.cs",
    ...
    "Tools/p1_event_audit.py",
    "Tools/p1_freeze_manifest.py",
    "Tools/p1_gate_report.py",
    "Tools/P1_MODERATION_TEMPLATE.csv",
    "Tools/P1_SESSION_NOTES_TEMPLATE.md",
    ...
    "Tools/tests/test_p0_contract_parity.py",
    "Tools/tests/test_p0_freeze_manifest.py",
    "Tools/tests/test_p0_gate_report.py",
    "Tools/tests/test_p1_event_audit.py",
    "Tools/tests/test_p1_freeze_manifest.py",
    "Tools/tests/test_p1_gate_report.py",
